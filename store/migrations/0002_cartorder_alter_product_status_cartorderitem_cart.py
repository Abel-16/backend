    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_free', models.DecimalField(decimal_places=2, default=0.0, max_digits=12)),
                ...
                ('payment_status', models.CharField(choices=[('processing', 'Processing'), ('paid', 'Paid'), ('Cancelled', 'Cancelled'), ('pending', 'Pending')], default='processing', max_length=100)),
                ('order_status', models.CharField(choices=[('fulfilled', 'Fulfilled'), ('Cancelled', 'Cancelled'), ('pending', 'Pending')], default='pending', max_length=100)),
                ('initial_total', models.DecimalField(decimal_places=2, default=0.09, max_digits=12)),
                ...
                ('oid', shortuuid.django_fields.ShortUUIDField(alphabet=None, length=10, max_length=19, prefix='ASP-Order', unique=True)),
                ...
                ('farmer', models.ManyToManyField(blank=True, to='farmer.farmer')),
            ],
        ),
        migrations.AlterField(
            model_name='product',
            name='status',
            field=models.CharField(choices=[('in_review', 'In review'), ('draft', 'Drafted'), ('published', 'Published'), ('disabled', 'Disabled')], default='published', max_length=100),
        ),
        migrations.CreateModel(
            name='CartOrderItem',
            fields=[
